...
import { MdAdd, MdDelete, MdPalette, MdSave, MdUpload } from "react-icons/md";
import { ColorPaletteModal } from "@/components/dashboard/settings/ColorPaletteModal";
import {
    ...
    <form onSubmit={handleSubmit} className="space-y-7">
      ...
      {isPaletteModalOpen ? (
        <ColorPaletteModal
          ...
          onPresetChange={applyPalettePreset}
